...
class MiningTask implements Runnable {
    ...
    private void warmUp() {
        ...
        queue.thenRun(4, () -> setPistonState(pistons[0], true), SchedulerContext.of(pistons[0].getLocation()));
        queue.thenRun(10, () -> setPistonState(pistons[0], false), SchedulerContext.of(pistons[0].getLocation()));

        queue.thenRun(8, () -> setPistonState(pistons[1], true), SchedulerContext.of(pistons[1].getLocation()));
        queue.thenRun(10, () -> setPistonState(pistons[1], false), SchedulerContext.of(pistons[1].getLocation()));
        ...
        queue.thenRun(
                ...
                SchedulerContext.of(chest.getLocation()));

        queue.thenRun(6, () -> setPistonState(pistons[0], true), SchedulerContext.of(pistons[0].getLocation()));
        queue.thenRun(9, () -> setPistonState(pistons[0], false), SchedulerContext.of(pistons[0].getLocation()));

        queue.thenRun(4, () -> setPistonState(pistons[1], true), SchedulerContext.of(pistons[1].getLocation()));
        queue.thenRun(7, () -> setPistonState(pistons[1], false), SchedulerContext.of(pistons[1].getLocation()));

        queue.thenRun(3, () -> setPistonState(pistons[0], true), SchedulerContext.of(pistons[0].getLocation()));
        queue.thenRun(5, () -> setPistonState(pistons[0], false), SchedulerContext.of(pistons[0].getLocation()));

        queue.thenRun(2, () -> setPistonState(pistons[1], true), SchedulerContext.of(pistons[1].getLocation()));
        queue.thenRun(4, () -> setPistonState(pistons[1], false), SchedulerContext.of(pistons[1].getLocation()));

        queue.thenRun(1, () -> setPistonState(pistons[0], true), SchedulerContext.of(pistons[0].getLocation()));
        queue.thenRun(3, () -> setPistonState(pistons[0], false), SchedulerContext.of(pistons[0].getLocation()));

        queue.thenRun(1, () -> setPistonState(pistons[1], true), SchedulerContext.of(pistons[1].getLocation()));
        queue.thenRun(2, () -> setPistonState(pistons[1], false), SchedulerContext.of(pistons[1].getLocation()));

        queue.thenRun(1, this, SchedulerContext.of(chest.getLocation()));
    ...
    public void run() {
        ...
        queue.thenRun(1, () -> setPistonState(pistons[1], true), SchedulerContext.of(pistons[1].getLocation()));
        queue.thenRun(3, () -> setPistonState(pistons[1], false), SchedulerContext.of(pistons[1].getLocation()));
